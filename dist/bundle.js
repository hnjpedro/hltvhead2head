...
var verifyAndSearch = function verifyAndSearch() {
  if (!isSearching) {
    if (input1.value && input2.value) {
      ...
      (0, _sweetalert["default"])("Uh, oh!", "Please add second player", "warning");
    } else if (!input1.value && input2.value) {
      (0, _sweetalert["default"])("Uh, oh!", "Please add first player", "warning");
    } else {
      (0, _sweetalert["default"])("Uh, oh!", "Please add players", "warning");
    }
  } else {
    (0, _sweetalert["default"])("Uh, oh!", "Please try again after current search is finished", "warning");
  }
};
    ...
    var _loop = function _loop(_i4) {
      ...
      tooltips[_i4].addEventListener("click", function (event) {
        ...
        if (!activeTool.length) {
          ...
          if (event.target.className == "title" || event.target == activeTool[0].previousSibling) {
            activeTool[0].remove();
          } else {
            activeTool[0].remove();
            auxTool();
...
},{"./allplayers":1,"axios":3,"moment":38,"sweetalert":40}],3:[function(require,module,exports){
...
},{"../adapters/http":4,"../adapters/xhr":4,"../core/AxiosError":10,"../helpers/normalizeHeaderName":27,"../helpers/toFormData":32,"../utils":34,"./env/FormData":28,"./transitional":18,"_process":39}],18:[function(require,module,exports){
'use strict';
...
},{"timers":41}],41:[function(require,module,exports){
(function (setImmediate,clearImmediate){(function (){
...
},{"process/browser.js":39,"timers":41}]},{},[2]);
